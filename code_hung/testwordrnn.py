...
#print(len(jj))
json_path='/Users/hungphan/git/MLFixCErrors/fixUndeclaredVariables/jsonfiles/'
json_paths=os.listdir(json_path)
json_paths.sort(key=lambda f: int(''.join(filter(str.isdigit, f))))
output_data_path='/Users/hungphan/git/MLFixCErrors/fixUndeclaredVariables/output_data_files/'
fop_output_json_files='/Users/hungphan/git/MLFixCErrors/fixUndeclaredVariables/output_json_files/file_{}.json'
